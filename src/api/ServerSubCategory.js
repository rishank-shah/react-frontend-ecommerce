...
export const updateSubCategory = async(authtoken,subcategory,slug) =>
    await axios.put(`${process.env.REACT_APP_API_URL}/subcategory/${slug}`,{
        name:subcategory
    },{
        headers:{
            authtoken:authtoken
...
export const createSubCategory = async(authtoken,subcategory,parent) =>
    await axios.post(`${process.env.REACT_APP_API_URL}/subcategory`,{
        name:subcategory,
        parent
    },{
        headers:{
